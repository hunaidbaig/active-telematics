...
function UploadsNavbar({ toggleHandle }) {
  return (
    ...
    <div className="container-fluid py-1 px-3">
      <nav aria-label="breadcrumb">
        <ol className="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
          ...
          <li className="breadcrumb-item text-sm text-dark active" aria-current="page">Uploads</li>
        </ol>
        <h6 className="font-weight-bolder mb-0">Uploads</h6>
      </nav>
